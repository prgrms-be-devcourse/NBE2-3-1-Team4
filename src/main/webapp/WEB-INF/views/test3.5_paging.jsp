...
<head>
    ...
    <style>
        ...
        .data-section {
            max-height: 70vh !important; /* 스크롤 영역의 최대 높이 */
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            productQuantities = savedQuantities;

            updateUIFromQuantities();
            ...
            function updateUIFromQuantities() {
                const summaryItems = document.querySelectorAll('.data-section h6');
                summaryItems.forEach(function (summaryItem) {
                    const productName = summaryItem.innerText.split(' ')[0].trim(); // 상품 이름 추출
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h5><b>상품 데이터</b></h5>
                <hr>
                <div class="data-section" style="max-height: 300px; overflow-y: auto; border: 1px solid #ccc; padding: 10px; background-color: #fff;">
